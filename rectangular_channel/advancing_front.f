...
c============================   
      ...
      subroutine advancing_front(xg2,yg2)
     ...
     +                   ,previous_edge,next_edge
      ...
      common /xxx04/ first_edge,last_edge,current_edge
      common /xxx05/ previous_edge
c-----------------------------------------------------------------------------------
...
c--------------------------------------------------------------------------------
      ...
      do while(k<=number_points)
          ...
          call push_element(previous_edge,current_edge
...
c----------------------------------------------------------------------------
      ...
      do while(current_edge%next.ne.first_edge)
          ...
          c1=fpy-(slope1*fpx)
          c2=lpy-(slope2*lpx)
          xi=(c2-c1)/(slope1-slope2)
          yi=((slope1*c2)-(slope2*c1))/(slope1-slope2)
